...
public:
	...
	MotorDriver() = delete;
	MotorDriver(const bool& emergency_state, const uint8_t driver_address, const SendParamsType& set_driver_params, ControlAreaNetwork& can_interface) :
	...
	MotorDriver(const bool& emergency_state, uint8_t driver_address, ControlAreaNetwork& can_interface) :
		emergency_state_(emergency_state),
		usingMotorDriverAddress_(driver_address),
		can_interface_(can_interface){}
